...
namespace WeBook.Helper
{
    public static class UIActions
    {
        ...
        #region STADIUM SCREEN - Iframe
        //TODO: This is a bit hacky but some sites load the map in an iframe that doesn't have a unique identifier. We have to loop through all iframes and check for the presence of a canvas element to find the
        //right one. If there are multiple iframes with canvas elements, this could cause issues.
        // --- Iframe handling ---
        ...
        #region STADIUM SCREEN - CHECK OUT FUNCTIONALITY
        // --- Checkout ---
